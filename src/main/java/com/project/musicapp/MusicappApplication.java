...
public class MusicappApplication {
	...
	public CommandLineRunner demo(UserRepository urepository, FavoriteSongRepository fsrepository,
		...
		return (args) -> {
			...
			User user = new User("first", "last", "test@musicapp.com", "user", "$2a$10$Nup.FsJ6XeYoSzXeqUaDHu5gacmUKo0pqKeZKFckzNPOsxQfWQBIW", "USER");
			User admin = new User("aFirst", "aLast", "admin@musicapp.com", "admin" ,"$2a$10$vlBCYg6gWK9hrMfgURiM7eCwTq9HuYPONzcQxO.a/UMAuqovaHa/W" , "USER, ADMIN");
			...
			fsrepository.save(new FavoriteSong(Long.valueOf(3479257), user.getId(), "Dream Theater", "The Dark Eternal Night"));
